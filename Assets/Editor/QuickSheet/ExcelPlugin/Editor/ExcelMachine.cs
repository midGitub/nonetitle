...
namespace UnityQuickSheet
{
    ...
    internal class ExcelMachine : BaseMachine
    {
		...
		public string exportFilePath; //add by nichos

		public List<string> importFileList = new List<string>(); //add by nichos
        ...
        private readonly string excelTemplatePath = "Editor/QuickSheet/ExcelPlugin/Templates";
