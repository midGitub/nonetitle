...
namespace UnityQuickSheet
{
    internal class ScriptGenerator
    {
        ...
        {
			m_Writer.WriteLine (m_Indentation + "#if !CORE_DLL");
            m_Writer.WriteLine (m_Indentation + "[UnityEngine.SerializeField]");
			m_Writer.WriteLine (m_Indentation + "#endif");
		...
		{
			//only set the first character to lower
...
//            return ti.ToTitleCase(field.Name);
			return ToUpperString(field.Name);
        }
