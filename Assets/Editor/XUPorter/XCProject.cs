	...
	public partial class XCProject : System.IDisposable
	{
		...
		public PBXDictionary AddFile( string filePath, PBXGroup parent = null, string tree = "SOURCE_ROOT", bool createBuildFiles = true, bool weak = false )
		{
			...
			if( !( File.Exists( absPath ) || Directory.Exists( absPath ) ) && tree.CompareTo( "SDKROOT" ) != 0 ) {
				...
				Debug.Log( "Source Root File abs " + absPath + " projectRoot " + projectRootPath);
				System.Uri fileURI = new System.Uri( absPath );
				System.Uri rootURI = new System.Uri( ( projectRootPath) );
				filePath = rootURI.MakeRelativeUri( fileURI ).ToString();
				filePath = filePath.Replace ("..", "../Assets");
				Debug.Log( "Source Root FilePath" + filePath);
			}
		...
		{	
			...
			{
				Debug.Log( "No frameworks to add..." );
			}
			...
			{
				Debug.Log( "No embed_binaries to add..." );
			}
			...
			{
				Debug.Log( "No headerpaths to add..." );
			}
			...
			{
				Debug.Log( "No compiler flags to add..." );
			}
			...
			{
				Debug.Log( "No linker flags to add..." );
			}
