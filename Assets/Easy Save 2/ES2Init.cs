...
public class ES2Init : MonoBehaviour
{
	...
	public static void Init()
	{
		...
		ES2TypeManager.types[typeof(IAPData)] = new ES2UserType_IAPData();
		ES2TypeManager.types[typeof(LevelData)] = new ES2UserType_LevelData();
		ES2TypeManager.types[typeof(System.DateTime)] = new ES2_DateTime();
		ES2TypeManager.types[typeof(JackpotData)] = new ES2_JackpotData();
		ES2TypeManager.types[typeof(InitMachineSeedInfo)] = new ES2_InitMachineSeedInfo();
		ES2TypeManager.types[typeof(TournamentScoreInfor)] = new ES2_TournamentScore();
		ES2TypeManager.types[typeof(TournamentLastRewardInfor)] = new ES2_TournamentReward();
		#if true
		ES2TypeManager.types[typeof(MailInfor)] = new ES2_Mail();
		#else
		ES2TypeManager.types [typeof(MailInfor)] = new ES2_MailInfo ();
		#endif
	}
}
