...
namespace Pomelo.DotNetClient
{
    public class MessageProtocol
    {
		...
		private PomeloProtobuf.Protobuf protobuf;
        ...
        public MessageProtocol(JsonObject dict, JsonObject serverProtos, JsonObject clientProtos)
        {
			...
			protobuf = new PomeloProtobuf.Protobuf(clientProtos, serverProtos);
        ...
        public byte[] encode(string route, uint id, JsonObject msg)
        {
            ...
            if (id > 0)
            {
				byte[] bytes = PomeloProtobuf.Encoder.encodeUInt32(id);
        ...
        public Message decode(byte[] buffer)
        {
            ...
            {
                int length;
				id = (uint)PomeloProtobuf.Decoder.decodeUInt32(offset, buffer, out length);
