...
[System.Serializable]
#if CORE_DLL
public class GroupRepresentSheet : IExcelSheet<GroupRepresentData>
#else
public class GroupRepresentSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public GroupRepresentData[] dataArray;
    public GroupRepresentData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new GroupRepresentData[0];
    }
}
