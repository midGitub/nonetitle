...
[System.Serializable]
#if CORE_DLL
public class MapSettingSheet : IExcelSheet<MapSettingData>
#else
public class MapSettingSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public MapSettingData[] dataArray;
    public MapSettingData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new MapSettingData[0];
    }
}
