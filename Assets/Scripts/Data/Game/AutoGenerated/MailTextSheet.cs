...
[System.Serializable]
#if CORE_DLL
public class MailTextSheet : IExcelSheet<MailTextData>
#else
public class MailTextSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public MailTextData[] dataArray;
    public MailTextData[] DataArray { get { return dataArray; } set { dataArray = value; } }
