...
[System.Serializable]
#if CORE_DLL
public class AdStrategySheet : IExcelSheet<AdStrategyData>
#else
public class AdStrategySheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public AdStrategyData[] dataArray;
    public AdStrategyData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new AdStrategyData[0];
    }
}
