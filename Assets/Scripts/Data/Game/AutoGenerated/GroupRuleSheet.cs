...
[System.Serializable]
#if CORE_DLL
public class GroupRuleSheet : IExcelSheet<GroupRuleData>
#else
public class GroupRuleSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public GroupRuleData[] dataArray;
    public GroupRuleData[] DataArray { get { return dataArray; } set { dataArray = value; } }
