...
[System.Serializable]
#if CORE_DLL
public class PiggyInfoSheet : IExcelSheet<PiggyInfoData>
#else
public class PiggyInfoSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public PiggyInfoData[] dataArray;
    public PiggyInfoData[] DataArray { get { return dataArray; } set { dataArray = value; } }
