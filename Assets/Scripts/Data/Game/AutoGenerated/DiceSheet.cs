...
[System.Serializable]
#if CORE_DLL
public class DiceSheet : IExcelSheet<DiceData>
#else
public class DiceSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public DiceData[] dataArray;
    public DiceData[] DataArray { get { return dataArray; } set { dataArray = value; } }
