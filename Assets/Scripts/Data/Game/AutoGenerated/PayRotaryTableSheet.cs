...
[System.Serializable]
#if CORE_DLL
public class PayRotaryTableSheet : IExcelSheet<PayRotaryTableData>
#else
public class PayRotaryTableSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public PayRotaryTableData[] dataArray;
    public PayRotaryTableData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new PayRotaryTableData[0];
    }
}
