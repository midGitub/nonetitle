...
[System.Serializable]
#if CORE_DLL
public class BetOptionSheet : IExcelSheet<BetOptionData>
#else
public class BetOptionSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public BetOptionData[] dataArray;
    public BetOptionData[] DataArray { get { return dataArray; } set { dataArray = value; } }
