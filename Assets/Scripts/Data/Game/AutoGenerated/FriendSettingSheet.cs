...
[System.Serializable]
#if CORE_DLL
public class FriendSettingSheet : IExcelSheet<FriendSettingData>
#else
public class FriendSettingSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public FriendSettingData[] dataArray;
    public FriendSettingData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new FriendSettingData[0];
    }
}
