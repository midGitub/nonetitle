...
[System.Serializable]
#if CORE_DLL
public class LevelConfigSheet : IExcelSheet<LevelConfigData>
#else
public class LevelConfigSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public LevelConfigData[] dataArray;
    public LevelConfigData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new LevelConfigData[0];
    }
}
