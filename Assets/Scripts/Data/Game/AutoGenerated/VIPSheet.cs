...
[System.Serializable]
#if CORE_DLL
public class VIPSheet : IExcelSheet<VIPData>
#else
public class VIPSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public VIPData[] dataArray;
    public VIPData[] DataArray { get { return dataArray; } set { dataArray = value; } }
