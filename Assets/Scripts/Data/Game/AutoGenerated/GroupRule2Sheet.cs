...
[System.Serializable]
#if CORE_DLL
public class GroupRule2Sheet : IExcelSheet<GroupRule2Data>
#else
public class GroupRule2Sheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public GroupRule2Data[] dataArray;
    public GroupRule2Data[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new GroupRule2Data[0];
    }
}
