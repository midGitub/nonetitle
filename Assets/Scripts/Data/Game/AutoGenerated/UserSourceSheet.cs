...
[System.Serializable]
#if CORE_DLL
public class UserSourceSheet : IExcelSheet<UserSourceData>
#else
public class UserSourceSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public UserSourceData[] dataArray;
    public UserSourceData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new UserSourceData[0];
    }
}
