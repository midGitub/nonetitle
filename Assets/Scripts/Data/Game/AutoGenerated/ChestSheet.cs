...
[System.Serializable]
#if CORE_DLL
public class ChestSheet : IExcelSheet<ChestData>
#else
public class ChestSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public ChestData[] dataArray;
    public ChestData[] DataArray { get { return dataArray; } set { dataArray = value; } }
