...
[System.Serializable]
#if CORE_DLL
public class CompensationSheet : IExcelSheet<CompensationData>
#else
public class CompensationSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public CompensationData[] dataArray;
    public CompensationData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new CompensationData[0];
    }
}
