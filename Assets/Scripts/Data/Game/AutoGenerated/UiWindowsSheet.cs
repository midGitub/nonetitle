...
[System.Serializable]
#if CORE_DLL
public class UiWindowsSheet : IExcelSheet<UiWindowsData>
#else
public class UiWindowsSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public UiWindowsData[] dataArray;
    public UiWindowsData[] DataArray { get { return dataArray; } set { dataArray = value; } }
