...
[System.Serializable]
#if CORE_DLL
public class IAPCatalogSheet : IExcelSheet<IAPCatalogData>
#else
public class IAPCatalogSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public IAPCatalogData[] dataArray;
    public IAPCatalogData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new IAPCatalogData[0];
    }
}
