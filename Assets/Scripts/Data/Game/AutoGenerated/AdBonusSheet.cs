...
[System.Serializable]
#if CORE_DLL
public class AdBonusSheet : IExcelSheet<AdBonusData>
#else
public class AdBonusSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public AdBonusData[] dataArray;
    public AdBonusData[] DataArray { get { return dataArray; } set { dataArray = value; } }
