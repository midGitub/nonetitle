...
[System.Serializable]
#if CORE_DLL
public class ContentSheet : IExcelSheet<ContentData>
#else
public class ContentSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public ContentData[] dataArray;
    public ContentData[] DataArray { get { return dataArray; } set { dataArray = value; } }
