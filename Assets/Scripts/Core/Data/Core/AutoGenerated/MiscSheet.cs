...
[System.Serializable]
#if CORE_DLL
public class MiscSheet : IExcelSheet<MiscData>
#else
public class MiscSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public MiscData[] dataArray;
    public MiscData[] DataArray { get { return dataArray; } set { dataArray = value; } }
