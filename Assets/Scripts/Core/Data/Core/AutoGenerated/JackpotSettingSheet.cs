...
[System.Serializable]
#if CORE_DLL
public class JackpotSettingSheet : IExcelSheet<JackpotSettingData>
#else
public class JackpotSettingSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public JackpotSettingData[] dataArray;
    public JackpotSettingData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new JackpotSettingData[0];
    }
}
