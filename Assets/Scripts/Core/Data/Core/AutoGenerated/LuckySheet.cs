...
[System.Serializable]
#if CORE_DLL
public class LuckySheet : IExcelSheet<LuckyData>
#else
public class LuckySheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public LuckyData[] dataArray;
    public LuckyData[] DataArray { get { return dataArray; } set { dataArray = value; } }
