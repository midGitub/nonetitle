...
[System.Serializable]
#if CORE_DLL
public class NearHitSheet : IExcelSheet<NearHitData>
#else
public class NearHitSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public NearHitData[] dataArray;
    public NearHitData[] DataArray { get { return dataArray; } set { dataArray = value; } }
