...
[System.Serializable]
#if CORE_DLL
public class PaylineSheet : IExcelSheet<PaylineData>
#else
public class PaylineSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public PaylineData[] dataArray;
    public PaylineData[] DataArray { get { return dataArray; } set { dataArray = value; } }
