...
[System.Serializable]
#if CORE_DLL
public class SymbolSheet : IExcelSheet<SymbolData>
#else
public class SymbolSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public SymbolData[] dataArray;
    public SymbolData[] DataArray { get { return dataArray; } set { dataArray = value; } }
