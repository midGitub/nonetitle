...
[System.Serializable]
#if CORE_DLL
public class PayoutSheet : IExcelSheet<PayoutData>
#else
public class PayoutSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public PayoutData[] dataArray;
    public PayoutData[] DataArray { get { return dataArray; } set { dataArray = value; } }
