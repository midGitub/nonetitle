...
[System.Serializable]
#if CORE_DLL
public class NearHitDistSheet : IExcelSheet<NearHitDistData>
#else
public class NearHitDistSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public NearHitDistData[] dataArray;
    public NearHitDistData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new NearHitDistData[0];
    }
}
