...
[System.Serializable]
#if CORE_DLL
public class WheelSheet : IExcelSheet<WheelData>
#else
public class WheelSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public WheelData[] dataArray;
    public WheelData[] DataArray { get { return dataArray; } set { dataArray = value; } }
