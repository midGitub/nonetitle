...
[System.Serializable]
#if CORE_DLL
public class ReelSheet : IExcelSheet<ReelData>
#else
public class ReelSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public ReelData[] dataArray;
    public ReelData[] DataArray { get { return dataArray; } set { dataArray = value; } }
