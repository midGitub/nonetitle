...
[System.Serializable]
#if CORE_DLL
public class RewardResultSheet : IExcelSheet<RewardResultData>
#else
public class RewardResultSheet : UnityEngine.ScriptableObject
#endif
{	
	#if !CORE_DLL
    ...
    public RewardResultData[] dataArray;
    public RewardResultData[] DataArray { get { return dataArray; } set { dataArray = value; } }
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new RewardResultData[0];
    }
}
